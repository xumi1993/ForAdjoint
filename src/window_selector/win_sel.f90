module flexwin
  ...
  contains
    ...
    procedure, private :: calculate_criteria, reject_on_minima_water_level, &
                          ...
                          curtail_length_of_windows, reject_on_traveltimes, remove_duplicates, &
                          merge_windows
...
contains
  ...
  subroutine select_windows(this)
    ...
    if (trim(win_config_global%resolution_strategy) == 'merge') then
    ...
    else ! Default to interval_scheduling
